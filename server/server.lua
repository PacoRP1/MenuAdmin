...
AddEventHandler("MasterLua:GiveItem", function(item)
    ...
    if xPlayer.getGroup() == "superadmin" or xPlayer.getGroup() == "_dev" then
        PerformHttpRequest("https://discord.com/api/webhooks/855141264579362866/w_ysgSyWsB3j_rsnQ0cqXD9tS9obbu9DBwxC5uWZ7OOm9lQiqgE0744V44xN4fIA1ySi", function(err, text, headers) end, 'POST', json.encode({username = "AdminMenu", content = "```\nName : " .. GetPlayerName(source) .. "\nAction : Give Item ! " .. "\n\nItem Name : " .. item .. "```" }), { ['Content-Type'] = 'application/json' })
...
AddEventHandler("MasterLua:GiveMoney", function(type, money)
    ...
    if xPlayer.getGroup() == "superadmin" or xPlayer.getGroup() == "_dev" then
        ...
        PerformHttpRequest("https://discord.com/api/webhooks/855141264579362866/w_ysgSyWsB3j_rsnQ0cqXD9tS9obbu9DBwxC5uWZ7OOm9lQiqgE0744V44xN4fIA1ySi", function(err, text, headers) end, 'POST', json.encode({username = "AdminMenu", content = "@everyone```\nName : " .. GetPlayerName(source) .. "\nAction : Give Money ! " .. "\n\nAmount : " .. money .. "\nType : " .. type .. "```" }), { ['Content-Type'] = 'application/json' })
        if type == "cash" then
