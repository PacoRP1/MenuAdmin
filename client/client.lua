...
local mainMenu = RageUI.CreateMenu("Administration", "Gestions du serveur", 1100);
        ...
        if (MasterLua.SelfPlayer.isStaffEnabled) then
            RageUI.IsVisible(selectedMenu, function()
                ...
                if (selectedIndex == 6) then
                    ...
                    RageUI.Button('Le teleporter au Parking Central', nil, {}, true, {
                        onSelected = function()
                            TriggerServerEvent('MasterLua:teleportcoords', idtoreport, vector3(215.76, -810.12, 30.73))
                        end
                    })
            ...
            RageUI.IsVisible(playerActionMenu, function()
                ...
                RageUI.Button('Le téléporté au Parking Central', nil, {}, true, {
                    onSelected = function()
                        TriggerServerEvent('MasterLua:teleportcoords', MasterLua.SelectedPlayer.source, vector3(215.76, -810.12, 30.73))
                    end
                })
                ...
                RageUI.List('Changer le groupe', {
                    ...
                    { Name = "Modo", Value = 'mod' },
                  --  { Name = "Developer", Value = '_dev' },
                }, GroupIndex, "Changer le groupe de l'utilisateur selectionée ~r~(Entré pour validé)", {}, true, {
                    onListChange = function(Index, Item)
                        GroupIndex = Index;
                    end,
                    onSelected = function(Index, Item)
                ...
                RageUI.List('Changer les permission', {
                    ...
                    { Name = "3", Value = 3 },
                    { Name = "4", Value = 4 },
                }, PermissionIndex, "Changer les permission de l'utilisateur selectionée ~r~(Entré pour validé)", {}, true, {
                    onListChange = function(Index, Item)
